    ...
    <div class="game-details">
      <header class="game-details__header">
        <div class="game-image">
          <img :src="`https://raw.githubusercontent.com/ja1984/sogdb/master/images/${game.image_slug}.webp`" crossorigin="anonymous" class="image" />
        ...
        <div v-if="playUrl && !isPreOrder" class="play-link">
          <a :href="playUrl" target="_blank" class="play-link__button">
            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" class="play-link__icon" width="24">
